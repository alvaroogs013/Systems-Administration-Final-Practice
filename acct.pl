...
my $db=DBI->connect('dbi:mysql:database=avanzadb;host=localhost','administrador','admin') or die print("<p>el error es".DBI->errstr."</p>");
...
my $body = "Daily report from the server AvanzaII";
