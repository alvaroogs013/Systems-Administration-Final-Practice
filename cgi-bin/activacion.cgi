...
if( $username ne $H_user){
        ...
        if(@chk_id){
                # Create the user in the server
                        # Change state to 2
                my $q = $db->prepare("update avanzadb.users set state='2' where id=?");
                $q->execute($username);
                $q->finish();
                ...
                make_path($home_path, { owner => "avanzavip", group => "vip" });
                ...
                if (@chk_id[1] == 1){
                        ...
                        my $grp_E = Linux::usermod->new("alumnos", 231);
                        ...
                        my $file = "/empty/principal_alumno.html";
                        my $file_2 = "/empty/style.css";
                        my $dst = "/home/$username/pagina_personal/";
                        ...
                        my $args_3 = "/home/$username/pagina_personal/principal_alumno.html /home/$username/pagina_personal/index.html";
                        my $su_mv = Sudo->new({
                                sudo            => '/usr/bin/sudo',
                                username        => 'root',
                                password        => 'compu',
                ...
                my $body = ("<h1> El registro en AvanzaII ha acabado correctamente</h1><p>Ya puede disfrutar de todos los servicios que le ofrecemos en <a href='https://avanzaii'> AvanzaII</a>");
